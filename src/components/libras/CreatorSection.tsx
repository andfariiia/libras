...
export const CreatorSection = () => {
  return (
    <section className="py-10 md:py-16 bg-slate-900 border-t border-slate-800 text-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        <div className="bg-slate-950 rounded-3xl p-6 sm:p-10 border border-slate-800 shadow-2xl flex flex-col md:flex-row items-center gap-6">
          {/* Creator Avatar Frame */}
          <div className="relative shrink-0">
            <div className="w-32 h-32 sm:w-36 sm:h-36 rounded-full p-1.5 bg-gradient-to-tr from-teal-400 via-cyan-400 to-indigo-500 shadow-xl shadow-cyan-500/20">
              <img
          ...
          <div className="text-center md:text-left space-y-2">
            ...
            <div className="flex flex-wrap items-center justify-center md:justify-start gap-4 pt-2 text-xs font-bold text-slate-200">
