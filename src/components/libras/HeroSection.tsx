  ...
  return (
    <section className="relative pt-6 pb-8 md:pt-8 md:pb-12 overflow-hidden bg-slate-950 text-white">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10 text-center">
        ...
        <div className="my-5 max-w-3xl mx-auto relative group">
        ...
        <div className="max-w-xl mx-auto text-center my-6">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-5">
            ...
            <div className="text-center sm:text-left">
              <div className="flex items-center justify-center sm:justify-start text-amber-400 gap-1">
                ...
                <span className="text-xs sm:text-sm font-extrabold text-slate-100 ml-1.5">4.9 / 5.0</span>
              </div>
          ...
          {/* Trust Badges */}
          <div className="flex items-center justify-center gap-4 sm:gap-6 mt-4 text-xs sm:text-sm text-slate-300 font-bold">
            <span className="flex items-center gap-1.5">
              <Lock className="w-4 h-4 text-emerald-400" /> COMPRA SEGURA
            </span>
            <span className="flex items-center gap-1.5">
              <ShieldCheck className="w-4 h-4 text-cyan-400" /> SSL 256-BIT
            </span>
            <span className="flex items-center gap-1.5">
              <Zap className="w-4 h-4 text-amber-400" /> ACESSO IMEDIATO
            </span>
          </div>
        </div>
        ...
        <div className="pt-6 border-t border-slate-800/80 relative">
          ...
          <p className="text-xs sm:text-base text-slate-300 max-w-2xl mx-auto mb-6 font-medium">
            ...
            <div className="animate-marquee-slow flex items-center gap-6">
              {[...CAROUSEL_ITEMS, ...CAROUSEL_ITEMS, ...CAROUSEL_ITEMS].map((item, idx) => (
                ...
                >
                  ...
                  <p className="text-xs sm:text-sm font-extrabold text-slate-800 leading-snug px-2 py-0.5">
                    {item.title}
                  </p>
                </div>
              ))}
