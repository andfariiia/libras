...
export const HeroSection = ({ onCtaClick }: { onCtaClick: () => void }) => {
  return (
    <section className="relative pt-4 pb-6 md:pt-6 md:pb-10 overflow-hidden bg-slate-950 text-white">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10 text-center">
        {/* Top BNCC Pill */}
        <div className="inline-flex items-center gap-2 bg-gradient-to-r from-emerald-500/10 to-teal-500/10 border border-emerald-500/30 text-emerald-300 px-4 py-1.5 rounded-full text-xs sm:text-sm font-semibold backdrop-blur-md shadow-[0_0_20px_rgba(16,185,129,0.15)] mb-4">
          <CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0" />
          <span>Alinhado 100% à BNCC 2026</span>
        </div>

        {/* H1 Main Title */}
        <h1 className="text-3xl sm:text-5xl lg:text-6xl font-black tracking-tight leading-[1.12] max-w-4xl mx-auto mb-3">
          Jogos em Libras:{" "}
        ...
        {/* Subtitle */}
        <p className="text-base sm:text-lg text-slate-300 max-w-3xl mx-auto font-normal leading-relaxed mb-4 text-balance">
        ...
        <div className="my-4 max-w-3xl mx-auto relative group">
        ...
        <div className="max-w-xl mx-auto text-center my-6">
          ...
          {/* Trust Badges */}
          <div className="flex items-center justify-center gap-4 sm:gap-6 mt-3 text-[11px] text-slate-400 font-medium">
        ...
        <div className="pt-4 border-t border-slate-800/80 relative">
          ...
          <p className="text-xs sm:text-sm text-slate-400 max-w-2xl mx-auto mb-6 font-medium">
