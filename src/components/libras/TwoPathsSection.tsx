  ...
  return (
    <section className="py-10 md:py-16 bg-slate-950 text-white relative border-t border-slate-800">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center">
        <h2 className="text-2xl sm:text-4xl font-black mb-3 tracking-tight uppercase">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left max-w-4xl mx-auto">
          ...
          <div className="bg-slate-900/60 border border-slate-800 rounded-3xl p-6 relative">
            <div className="w-9 h-9 rounded-2xl bg-rose-500/10 border border-rose-500/30 text-rose-400 flex items-center justify-center font-black text-sm mb-4">
              ✕
            </div>
          ...
          <div className="bg-gradient-to-br from-teal-950/80 via-slate-900 to-cyan-950/80 border-2 border-cyan-400 rounded-3xl p-6 relative shadow-2xl shadow-cyan-500/20">
            ...
            <div className="w-9 h-9 rounded-2xl bg-gradient-to-tr from-teal-400 to-cyan-300 text-slate-950 flex items-center justify-center font-black text-sm mb-4 shadow-lg shadow-cyan-500/30">
              ✓
            </div>
            <h3 className="text-lg font-bold text-white mb-1.5">
            ...
            <ul className="space-y-3 text-xs sm:text-sm text-slate-100 font-medium">
              <li className="flex items-start gap-2.5">
