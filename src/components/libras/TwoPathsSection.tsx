  ...
  return (
    <section className="py-6 md:py-10 bg-slate-950 text-white relative border-t border-slate-800">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center">
        <h2 className="text-2xl sm:text-4xl font-black mb-2 tracking-tight uppercase">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left max-w-4xl mx-auto">
          {/* Path 1: Without Kit */}
          <div className="bg-slate-900/60 border border-slate-800 rounded-3xl p-5 sm:p-6 relative">
            <div className="w-8 h-8 rounded-2xl bg-rose-500/10 border border-rose-500/30 text-rose-400 flex items-center justify-center font-black text-sm mb-3">
              ✕
            </div>
          ...
          >
            ...
            <div className="w-8 h-8 rounded-2xl bg-gradient-to-tr from-teal-400 to-cyan-300 text-slate-950 flex items-center justify-center font-black text-sm mb-3 shadow-lg shadow-cyan-500/30">
              ✓
            </div>
            <h3 className="text-base sm:text-lg font-bold text-white mb-1">
