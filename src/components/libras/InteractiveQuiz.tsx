  ...
  return (
    <section className="py-12 bg-slate-950 text-white relative">
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
        <div className="bg-slate-900/90 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl relative backdrop-blur-xl">
          {!showResult ? (
            <div>
              {/* Quiz Header */}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6">
                {QUIZ_QUESTIONS[currentStep].options.map((opt, idx) => (
                  <button
                    ...
                    className="p-4 rounded-2xl bg-slate-950 border border-slate-800 hover:border-cyan-400 hover:bg-slate-800/80 transition-all text-left flex items-center gap-3 group cursor-pointer"
                  >
            ...
            <div className="text-center space-y-4 py-2">
              <div className="w-16 h-16 rounded-3xl bg-gradient-to-tr from-emerald-400 to-teal-500 text-slate-950 flex items-center justify-center mx-auto shadow-lg shadow-emerald-500/20">
                <PartyPopper className="w-8 h-8 font-black" />
              </div>
              ...
              <div className="bg-slate-950 border border-cyan-500/30 rounded-2xl p-4 max-w-md mx-auto text-left text-xs space-y-2">
              ...
              <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-3">
                <button
                  onClick={onFinish}
                  className="w-full sm:w-auto px-8 py-4 bg-gradient-to-r from-teal-400 via-cyan-300 to-amber-300 text-slate-950 font-black rounded-2xl text-sm shadow-xl shadow-cyan-500/20 hover:scale-105 transition-all cursor-pointer flex items-center justify-center gap-2"
                >
                ...
                <button
                  onClick={handleReset}
                  className="text-xs text-slate-400 hover:text-slate-200 flex items-center gap-1.5 py-2 cursor-pointer"
                >
