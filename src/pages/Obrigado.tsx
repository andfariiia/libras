...
const PACK_SUMMARY = [
  {
    ...
    desc: "Dinâmicas lúdicas para prender a atenção da turma e tornar as aulas 100% inclusivas.",
    tag: "Economize horas",
  },
  {
    icon: "🖨️",
    ...
    desc: "Exercícios estruturados em PDF (300 DPI) para Educação Infantil e Fundamental I.",
  ...
  },
  {
    ...
    desc: "Cartões visuais ilustrados e coloridos essenciais para fixar e revisar vocabulário.",
    tag: "Fixação Rápida",
  },
  {
    icon: "📚",
    ...
    desc: "Planos de aula completos e slides ilustrados para nunca mais ficar sem ideia.",
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-4 text-left max-w-3xl mx-auto">
            {UPSERT_ACERVO.map((item, idx) => (
              ...
              ><dyad-write path="src/pages/Obrigado.tsx" description="Finalizando a redução e compactação dos cards de benefícios na página Obrigado">
"use client";
